"""
text_generation/text_captioning/openai_runner.py
...
Usage:
    from text_generation.text_captioning.openai_runner import generate_caption_with_openai
...
def generate_caption_with_openai(input_data: dict) -> str:
    ...
    prompt = GENERALIZE_PROMPT_TEMPLATE.format(query=query, context=context)
