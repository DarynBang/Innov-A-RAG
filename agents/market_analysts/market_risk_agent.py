...
class MarketRiskAgent(BaseAgent):
    def __init__(self, name="MergeAgent", qa_model="openai"):
        ...
        self.prompt_with_patent = PromptTemplate.from_template(
            MARKET_RISK_PROMPT_WITH_PATENT
        )
        self.prompt_without_patent = PromptTemplate.from_template(
            MARKET_RISK_PROMPT_NO_PATENT
        )
    ...
    def run(self,
        ...
        logger.info("Running MarketRiskAgent")
        ...
        if patent_abstract:
            logger.info("Found patent abstract for MarketRiskAgent")
            ...
            logger.info("Patent abstract not found for MarketRiskAgent")
